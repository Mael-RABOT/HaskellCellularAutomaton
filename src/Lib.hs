...
options =
    [ Option [] ["rule"] (ReqArg Rule "") "Option rule"
    , Option [] ["start"] (ReqArg Start "") "Option start"
    , Option [] ["lines"] (ReqArg Lines "") "Option lines"
    , Option [] ["window"] (ReqArg Window "") "Option window"
    , Option [] ["move"] (ReqArg Move "") "Option move"
    ]
